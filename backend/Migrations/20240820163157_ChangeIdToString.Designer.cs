...
namespace Projet_Sqli.Migrations
{
    ...
    [Migration("20240820163157_ChangeIdToString")]
            ...
            modelBuilder.Entity("Projet_Sqli.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 8, 20, 17, 31, 57, 489, DateTimeKind.Local).AddTicks(653),
                            Name = "user",
                            UpdatedAt = new DateTime(2024, 8, 20, 17, 31, 57, 489, DateTimeKind.Local).AddTicks(700)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 8, 20, 17, 31, 57, 489, DateTimeKind.Local).AddTicks(704),
                            Name = "admin",
                            UpdatedAt = new DateTime(2024, 8, 20, 17, 31, 57, 489, DateTimeKind.Local).AddTicks(706)
                        });
                });
